                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="file"  name="name" value="{{ old('name') }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('hashtags') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="title" type="text" class="form-control" name="title" value="{{ old('title') }}" placeholder="Enter Hashtags that you would relate to your profile, content etc." required autofocus>
...
<!--                                     <option value="Academics">Academics</option>
                        ...
                        <div class="form-group{{ $errors->has('monthly_visitors') ? ' has-error' : '' }}">
                            <label for="monthly_visitors" style=" padding-right: 0px; " class="col-md-4 control-label">Snapchat</label>
                        ...
                        <div class="form-group{{ $errors->has('preferred_medium') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                ...
                                Others: <input type="text" value="7" name="preferred_medium[]" id="preferred_medium[]"><br>
                        ...
                        <div class="form-group{{ $errors->has('campaigns') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <input id="campaigns" type="radio" checked name="campaigns" value="no{{ old('campaigns') }}" placeholder="" autofocus>No
