...
<!--                     <li class="list-group-item text-right"><span class="pull-left"><strong class="">Fashion</strong></span> 125</li>
        ...
        <div class="col-sm-9" style="" contenteditable="false">
            ...
            <div class="panel panel-default target">
                ...
                <span style=" padding-left: 76%; "><a href="facebook_page_resource/create" class="btn btn-primary">Add +</a></span>
                </div>
                <div class="panel-body">
                <div class="row">
            ...
            <div class="panel panel-default target">
                ...
                <span style=" padding-left: 76%; "><a href="youtube_page_resource/create" class="btn btn-primary">Add +</a></span>
                </div>
                <div class="panel-body">
                <div class="row">
            ...
            <div class="panel panel-default target">
                ...
                <span style=" padding-left: 76%; "><a href="instagram_page_resource/create" class="btn btn-primary">Add +</a></span>
                </div>
                <div class="panel-body">
                <div class="row">
