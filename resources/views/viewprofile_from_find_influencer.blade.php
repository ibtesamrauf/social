            ...
            <div class="row">
                <div class="col-sm-12" align="center">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-2">
                                <a class="pull-right">
                                    ...
                                    <img title="profile image" class="img-circle img-responsive" src="{{ asset('uploads/'.$user_data->profile_picture) }}">
                                    @else
                            ...
                            <div class="col-sm-3">
                                ...
                                <ul class="list-group"> 
                                    <li class="list-group-item text-muted" contenteditable="false">
                                        @if (!empty($user_data->profile_picture)) 
                                            <img title="profile image" class="img-responsive" src="{{ asset('uploads/'.$user_data->profile_picture) }}">
                                        @else
                                            <img title="profile image" class="img-responsive" src="{{ asset('img/default-profile.png') }}">
                                        @endif
                                    </li>
                                    ...
                                    <li class="list-group-item text-right"><span class="pull-left"><strong class="">Joined</strong></span>{{ $user_data->created_at }}</li>
                                    <!-- <li class="list-group-item text-right"><span class="pull-left"><strong class="">Last seen</strong></span> Yesterday</li> -->
                                    <li class="list-group-item text-right"><span class="pull-left"><strong class="">Email</strong></span> {{ $user_data->email }}</li>
                    ...
                    <!--                     <li class="list-group-item text-right"><span class="pull-left"><strong class="">Fashion</strong></span> 125</li>
                                    ...
                                    @foreach($user_data->Users_Roles_hashtags as $hashtags)
                                ...
                                <ul class="list-group">
                                    ...
                                    @foreach($user_data->Users_preferred_medium as $preferred_medium)
                                    <li class="list-group-item text-right">
                                        <span class="pull-left">
                                            <strong class="">
                            ...
                            <div class="col-sm-9" style="" contenteditable="false">
                                ...
                                <div class="panel panel-default target">
                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="thumbnail">
                                                    <a href="{{ URL::to('/facebook_page_resource/'.$facebook_item->id) }}" class="">
                                ...
                                <div class="panel panel-default target">
                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="thumbnail">
                                                    <a href="{{ URL::to('youtube_page_resource/'.$youtube_item->id) }}" class="">
                                ...
                                <div class="panel panel-default target">
                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="thumbnail">
                                                    <a href="{{ URL::to('instagram_page_resource/'.$instagram_item->id) }}" class="">
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">{{ $user_data->name }} Portfolio</div>
                                    <div class="panel-body"> 
                                        <?php 
                                            if($user_data->Users_portfolio->isEmpty()){
                                                echo "No portfolio";
                                            }else{
                                        ?>
                                        <table class="table">
                                            ...
                                            <th>Link</th>
                                            <th>Description</th>
                                            @foreach($user_data->Users_portfolio as $key => $portfolio)
                                                <tr>
                                                    <td>{{ $key+1 }}</td>
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">{{ $user_data->name }} Previous Campaign</div>
                                    <div class="panel-body"> 
                                        <?php 
                                            if($user_data->User_previously_campaign->isEmpty()){
                                        ...
                                        <table class="table">
                                            ...
                                            <th>link</th>
                                            <th>details</th>
                                            @foreach($user_data->User_previously_campaign as $key => $previously_campaign)
                                                <tr>
                                                    <td>{{ $key+1 }}</td>
